...
class TestModelRunner:
    ...
    def test_run_model_basic_execution(
        ...
        result = run_model(
            ...
            scenario_meta={'name': 'Test Scenario', 'description': 'Test scenario for unit testing'}
        )
        ...
        required_bev_keys = [
            'vehicle_data', 'fees', 'energy_cost_per_km', 'annual_costs',
            'emissions', 'acquisition_cost', 'residual_value', 'battery_replacement',
            'npv_annual_cost', 'tco', 'externalities', 'social_tco',
            'charging_requirements', 'infrastructure_costs'
        ]
    ...
    def test_run_model_with_incentives(
        ...
        assert (result_with_incentives['bev_results']['acquisition_cost'] <= 
