...
from tco_app.services.scenario_application_service import (
    ScenarioApplicationService, ScenarioModification
)
...
class TestScenarioApplicationService:
    ...
    def test_apply_financial_param_modification(self, service, sample_data_tables):
        ...
        modified_tables = service.apply_modifications(
            sample_data_tables, modifications
        )
        
        # Check original table is unchanged
        original_price = sample_data_tables['financial_params'][
            sample_data_tables['financial_params']['finance_description'] == 'diesel_price'
    ...
    def test_apply_vehicle_modifier(self, service, sample_data_tables):
        ...
        diesel_mask = modified_tables['vehicle_models']['vehicle_drivetrain'] == 'Diesel'
        diesel_price = modified_tables['vehicle_models'][diesel_mask]['msrp_price'].iloc[0]
    ...
    def test_should_apply_modification_filtering(self, service):
        ...
        assert not service._should_apply_modification(mod_specific, 'Articulated', 'Diesel')
    ...
    def test_apply_incentive_modifier(self, service, sample_data_tables):
        ...
        rebate_mask = modified_tables['incentives']['incentive_type'] == 'purchase_rebate_aud'
        incentive_rate = modified_tables['incentives'][rebate_mask]['incentive_rate'].iloc[0]
