...
class TestTCOCalculationIntegration:
    ...
    def test_tco_comparison_integration(
        ...
        diesel_result = tco_service.calculate_single_vehicle_tco(diesel_calculation_request)

        # Execute comparison
        comparison = tco_service.compare_vehicles(bev_calculation_request, diesel_calculation_request)
        ...
        assert comparison.comparison_vehicle_result.vehicle_id == diesel_result.vehicle_id
        ...
        assert bev_result.lifetime_emissions_co2e < diesel_result.lifetime_emissions_co2e
        ...
        assert diesel_result.social_tco_total_lifetime > diesel_result.tco_total_lifetime
    ...
    def test_calculation_with_incentives_toggle(
        ...
        result_with_incentives = tco_service.calculate_single_vehicle_tco(request_with_incentives)
        ...
        result_without_incentives = tco_service.calculate_single_vehicle_tco(request_without_incentives)

        # With incentives should result in lower acquisition cost
        assert result_with_incentives.acquisition_cost < result_without_incentives.acquisition_cost

        # Infrastructure costs should also be affected by incentives
        assert (result_with_incentives.npv_infrastructure_cost < 
                result_without_incentives.npv_infrastructure_cost)

        # Overall TCO should be lower with incentives
        assert result_with_incentives.tco_total_lifetime < result_without_incentives.tco_total_lifetime

    def test_error_handling_with_invalid_vehicle_data(self, tco_service, bev_calculation_request):
