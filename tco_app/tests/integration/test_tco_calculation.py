"""Integration tests for complete TCO calculation pipeline."""
import pytest
...
class TestTCOCalculationIntegration:
    ...
    def test_complete_tco_calculation_integration(
        self, articulated_bev_vehicle, articulated_diesel_vehicle,
        standard_fees, standard_charging_options, standard_infrastructure_options,
        standard_financial_params, standard_emission_factors, standard_incentives
    ):
        ...
        result = run_model(
            ...
            diesel_fees=standard_fees[standard_fees['vehicle_id'] == articulated_diesel_vehicle['vehicle_id']],
            ...
            scenario_meta={'name': 'Integration Test', 'description': 'Full pipeline test'}
        )
        ...
        assert bev_results['emissions']['co2_per_km'] < diesel_results['emissions']['co2_per_km']
        ...
        assert bev_results['social_tco']['social_tco_lifetime'] > bev_results['tco']['npv_total_cost']
    ...
    def test_tco_comparison_makes_sense(
        ...
        assert bev['emissions']['lifetime_emissions'] < diesel['emissions']['lifetime_emissions']
