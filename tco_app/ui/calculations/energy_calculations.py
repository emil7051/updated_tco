...
class EnergyCalculator:
    ...
    def calculate_energy_costs(
        self, vehicle_data: Dict[str, pd.Series]
    ) -> Dict[str, Any]:
        ...
        bev_fees = vehicle_fees[
            vehicle_fees[DataColumns.VEHICLE_ID] == self.ui_context["selected_bev_id"]
        ]
        diesel_fees = vehicle_fees[
            vehicle_fees[DataColumns.VEHICLE_ID]
    ...
    def calculate_emissions(self, vehicle_data: Dict[str, pd.Series]) -> Dict[str, Any]:
        ...
        return {"bev": bev_emissions, "diesel": diesel_emissions}
