...
def render():
    ...
    st.info(
        "Sensitivity Analysis helps understand how changes in key parameters affect the TCO comparison."
    )
    ...
    if sensitivity_param == "Annual Distance (km) with Payload Effect":
        ...
        if sensitivity_param == "Annual Distance (km)":
            ...
            diesel_base = financial_params_with_ui[
                financial_params_with_ui[DataColumns.FINANCE_DESCRIPTION]
            ...
            if "weighted_electricity_price" in bev_results:
                ...
                electricity_base = charging_options[
            ...
            if electricity_base is None or not isinstance(
